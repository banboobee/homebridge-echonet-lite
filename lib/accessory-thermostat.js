...
module.exports = async function(platform, accessory, el, address, eoj) {
  ...
  this.updateValveHistory = async function () {
	...
	(this.state[`currentTemperature0x${0xBB.toString(16)}`] - this.state[`currentTemperature0x${0xB3.toString(16)}`])/this.state[`currentTemperature0x${0xB3.toString(16)}`]*100*2 + 50 : 50;
