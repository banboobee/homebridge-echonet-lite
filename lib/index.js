...
class ELPlatform {
  ...
  async _init() {
    ...
    if (this.config.device) {
      const ELtype = {
	heatercooler0:	{eoj: [1, 0x30], builder: require('./accessory')},
	heatercooler:	{eoj: [1, 0x30], builder: require('./accessory-heatercooler')},
	thermostat:	{eoj: [1, 0x30], builder: require('./accessory-thermostat')},
	thermostat2:	{eoj: [1, 0x30], builder: async (platform, accessory, el, address, eoj) => await require('./accessory-thermostat')(platform, accessory, el, address, eoj, false)},
	lightbulb1:	{eoj: [2, 0x90], builder: require('./accessory')},
	lightbulb2:	{eoj: [2, 0x91], builder: require('./accessory')},
      }
