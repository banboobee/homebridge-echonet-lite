...
//  el.on('notify', (x) => {
//    this.log('[NOTIFY] From: ' + x['device']['address'] + ' ----------------//----------');
//    this.log(JSON.stringify(x['message'], null, '  '));
//    this.log('');
//  });
  }

//Jun 27 03:48:09 raspberrypi homebridge[13249]: [6/27/2021, 3:48:09 AM] [ELPlatform] [NOTIFY] From: 192.168.1.18 --------------------------
//Jun 27 03:48:09 raspberrypi homebridge[13249]: [6/27/2021, 3:48:09 AM] [ELPlatform] {
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   "tid": 3895,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   "seoj": [
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     1,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     48,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     1
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   ],
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   "deoj": [
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     14,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     240,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     1
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   ],
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   "esv": "INF",
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   "prop": [
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     {
// Jun 27 03:48:09 raspberrypi homebridge[13249]:       "epc": 128,
// Jun 27 03:48:09 raspberrypi homebridge[13249]:       "edt": {
// Jun 27 03:48:09 raspberrypi homebridge[13249]:         "status": false
// Jun 27 03:48:09 raspberrypi homebridge[13249]:       },
// Jun 27 03:48:09 raspberrypi homebridge[13249]:       "buffer": {
// Jun 27 03:48:09 raspberrypi homebridge[13249]:         "type": "Buffer",
// Jun 27 03:48:09 raspberrypi homebridge[13249]:         "data": [
// Jun 27 03:48:09 raspberrypi homebridge[13249]:           49
// Jun 27 03:48:09 raspberrypi homebridge[13249]:         ]
// Jun 27 03:48:09 raspberrypi homebridge[13249]:       }
// Jun 27 03:48:09 raspberrypi homebridge[13249]:     }
// Jun 27 03:48:09 raspberrypi homebridge[13249]:   ]
...
//    .setCharacteristic(hap.Characteristic.SerialNumber, uuid)
	...
	this.log(`Found controller: ${address}`)
	controller[address] = new EchonetLite()
      }
      const buildAccessory = require('./accessory').bind(accessory)
      if (!await buildAccessory(this.log, this.api, accessory, controller[address], address, eoj))
